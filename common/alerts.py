...
class AlertsProcessor(ABC):
    ...
    def __init__(self) -> None:
        """
        Definition of all the parameters required
        to deliver notifications to the alert channel.
        """
        pass
    ...
    def send_handler_event_error(self, handler_name, event, error_message, **kwargs) -> None:
